...
import com.mycompany.customerbackend1.DiscountCode;
 ...
 */
@Stateless
@Path("com.mycompany.customerbackend1.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {
    @PersistenceContext(unitName = "com.mycompany_CustomerBackend1_war_1.0-SNAPSHOTPU")
